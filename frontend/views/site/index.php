			...
			<div class="focus focus1size floatLeft">
				<ul id="focus_1" class="rslides">
					<li class="background_five">
						<div class="limain">
							  <img src="<?php echo LuLu::getWebUrl()?>/images/banner05.jpg" border="0" />
					  	</div>
					</li>
					<li class="background_two">
						<div class="limain">
							  <img src="<?php echo LuLu::getWebUrl()?>/images/banner02.jpg" border="0" />
					  	</div>
					</li>
					<li class="background_three">
						<div class="limain">
							  <img src="<?php echo LuLu::getWebUrl()?>/images/banner03.jpg" border="0" />		
					  	</div>
					</li>
					<li class="background_four">
						<div class="limain">
							  <img src="<?php echo LuLu::getWebUrl()?>/images/banner04.jpg" border="0" />
					  	</div>
					</li>
					<li class="background_one">
						<div class="limain">
							<img src="<?php echo LuLu::getWebUrl()?>/images/banner01.jpg" border="0" />
					  	</div>
					</li>
